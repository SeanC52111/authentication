...
public class RTree implements ISpatialIndex
{
	...
	public void tranverse(final IVisitor v)
	{
		m_rwLock.read_lock();
		...
		try
		{
			...
			while (! st.empty())
			{
				...
				{
					//v.visitNode(n);
					System.out.print("leaf node shape:");
					System.out.println(n.getShape());
					System.out.println("leaf node id"+n.m_identifier);
				...
				else
				{
					...
					System.out.println(n.m_children);
					System.out.println(n.getShape());
					System.out.println("internal node id"+n.m_identifier);
					for (int cChild = 0; cChild < n.m_children; cChild++)
					{
	...
	public String createHashTable(int i,HashMap<String, String> hashnode,HashMap<String, String> hashdata)
	{
